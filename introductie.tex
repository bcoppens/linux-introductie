...
\begin{enumerate}
  ...
  \item Met enkele oefeningen op Dodona. Deze oefeningen zullen gradueel
    ...
    \url{https://dodona.ugent.be/nl/courses/1174/}. De ochtend van elk van de PC-sessies,
  ...
  \item Door te oefenen op een virtueel Linux-systeem dat jullie in VirtualBox
    ...
    \url{https://users.elis.ugent.be/~jdiroela/computer_architectuur.7z}. Je pakt dit
    ...
    (Als zou blijken dat jullie VirtualBox bij het opstarten lang op een zwart scherm zou blijven hangen, kan je proberen om te gaan naar Settings -$>$ Display en daar Enable 3D Acceleration aan te vinken.)
